...
this gem provides an Haml parser for GetText::Tools::XGetText. You can either
use it directly or through the provided Rake task. Here's an example on how to
use the later:
